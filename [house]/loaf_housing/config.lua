...
Config = {
    SellPercentage = 55, -- процент от първоначалната цена, която трябва да получите обратно, когато продавате къща.
    AddHouseBlips = true, -- да се добавят ли всички налични къщи към картата?
    AddBoughtHouses = false, -- добавяне на блипове за къщи, купени от други хора?
    EnableGarage = true, -- изисква моя скрипт за гараж. Разходи $ 10
    ...
    Props = { -- не се забърквайте с това, ако не знаете 110% какво правите
        ['trevor'] = `shell_trevor`,
        ['nice'] = `shell_v16mid`,
        ['lester'] = `shell_lester`,
        ['mansion'] = `shell_ranch`,
    ...
    Houses = { -- ALWAYS add a new house at the bottom of this list. Adding it at the top will just ruin the housing system! If you don't know what you're doing, DON'T DO ANYTHING!
        ...
        {['prop'] = 'trevor', ['door'] = vector3(-1112.25, -1578.4, 7.7), ['price'] = 60000},
        {['prop'] = 'trevor', ['door'] = vector3(-1114.34, -1579.47, 7.7), ['price'] = 60000},
        {['prop'] = 'trevor', ['door'] = vector3(-1114.95, -1577.57, 3.56), ['price'] = 60000},
        {['prop'] = 'trevor', ['door'] = vector3(373.9276, 427.8789, 144.7342), ['price'] = 60000},	
...
Strings = {
    ['Press_E'] = 'Натисни ~INPUT_CONTEXT~ до %s',
    ['Furniture_Categories'] = 'Категории',
    ['Manage_House'] = 'Управлявайте къщата си',
    ['Buy_House'] = 'Купи къща за #%s',
    ['Knock_House'] = 'Почукай на вратата',
    ['Your_House'] = 'Твоята къща',
    ['Buyable_House'] = 'Къща за купуване',
    ['Player_House'] = 'Къща на играч',
    ['Storage'] = 'Достъп до вашето хранилище',
    ['Sell_House'] = 'Продай за $%s',
    ['Enter_House'] = 'Влез в къщата',
    ['Sell_Confirm'] = 'Продавате ли къщата за $%s?',
    ['yes'] = 'Да',
    ['no'] = 'Не',
    ['Sold_House'] = 'Продадохте къщата си за $%s',
    ['Must_Sell'] = 'Можете да притежавате само една къща. Продайте къщата си, за да купите тази.',
    ['Buy_House_Confirm'] = 'Купувате ли къщата #%s за $%s?',
    ['Manage_Door'] = 'Управление',
    ['Accept'] = 'Приемете някой да влезе',
    ['Exit'] = 'Напусни къщата',
    ['Noone_Home'] = 'Изглежда никой не се е прибрал!',
    ['Someone_Knocked'] = 'Някой почука. Отидете до вратата, за да го пуснете!',
    ['Let_In'] = 'Пуснете някой да влезе',
    ['Accept_Player'] = 'Да пусна %s?',
    ['Waiting_Owner'] = 'Изчаква собственикът на къщата да го допусне.',
    ['ikea'] = 'IKEA',
    ['Buy_Furniture'] = 'Влез в IKEA',
    ['Buying_Furniture'] = '~INPUT_FRONTEND_LEFT~ ~INPUT_FRONTEND_RIGHT~ разгледайте\n~INPUT_CELLPHONE_DOWN~ ~INPUT_CELLPHONE_UP~ смяна на категорията (%s)\n~INPUT_FRONTEND_RDOWN~ купи %s за $%s\n~INPUT_MOVE_UP_ONLY~ ~INPUT_MOVE_DOWN_ONLY~ ~INPUT_VEH_CINEMATIC_UP_ONLY~ ~INPUT_VEH_CINEMATIC_DOWN_ONLY~ завъртане на камерата\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ завъртане\n\n~INPUT_FRONTEND_RRIGHT~ изход',
    ['Confirm_Purchase'] = 'Купи %s за $%s?',
    ['no_money'] = "Нямате достатъчно пари.",
    ['Bought_Furniture'] = 'Купих 1x %s за $%s',
    ['Furnish'] = 'Обзаведете къщата си',
    ['Store_Garage'] = 'Натисни ~INPUT_CONTEXT~ да приберете автомобила', 
    ['Re_Furnish'] = 'Премахнете поставените мебели',
    ['Remove'] = 'Премахване %s (#%s)',
    ['Amount'] = 'Колко?',
    ['Player_Inventory'] = 'Вашият инвентар',
    ['House_Inventory'] = 'Инвентар',
    ['Invalid_Amount'] = 'Невалидна сума.Моля, поставете номер.',
    ['Store'] = 'Магазин',
    ['Withdraw'] = 'Изтегли',
    ['Storage_Title'] = 'Шкаф',
    ['You_Stored'] = 'Съхранили сте %sx %s',
    ['You_Withdrew'] = 'Вие взехте %sx %s',
    ['Not_Enough'] = 'Нямате толкова много!',
    ['Not_Enough_House'] = 'В хранилището няма толкова много!',
    ['Weapons'] = 'Оръжия',
    ['Items'] = 'Предмети',
    ['No_Weapon'] = 'Нямате това оръжие в себе си!',
    ['bullets'] = 'куршуми', 
    ['Rotation'] = 'завъртане',
    ['Guests'] = 'Вашите гости трябва да напуснат къщата, преди да можете да направите това.',
    ['Garage'] = 'Влезте в гаража',
    ['No_Spawn'] = 'Не можах да намеря точка за изкарване на вашата къща.',
    ['Host_Left'] = 'Собственикът на къщата остави сървъра, а вие бяхте изгонени от къщата му.',
    ['No_Money'] = 'Нямате достатъчно пари!',
    ['Furnishing'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_DOWN~ ~INPUT_CELLPHONE_UP~ премести\n~INPUT_VEH_CINEMATIC_UP_ONLY~ ~INPUT_VEH_CINEMATIC_DOWN_ONLY~ височина\n~INPUT_ATTACK~ ~INPUT_AIM~ завъртане\n~INPUT_DETONATE~ сложи на земята\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ постави\n~INPUT_FRONTEND_CANCEL~ откажи'
}