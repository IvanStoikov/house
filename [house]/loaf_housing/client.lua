                    ...
                    if IsModelValid(model) then
                        ...
                        while not HasModelLoaded(model) do 
                            ...
                            if GetGameTimer() - startedLoading >= 1500 then
                                ESX.ShowNotification(('Моделът (%s) зарежда много време.Свържете се със собственика на сървъра.'):format(Config.Furniture[category[1]][current][2]))
                                break
                            end
                        end
                        ...
                        ESX.ShowNotification(('Моделът (%s) не е валиден.Свържете се със собственика на сървъра.'):format(Config.Furniture[category[1]][current][2]))
                    end
